...
--  Application d'une migration explicite : 202408271230345_ExtractionCAFDESV2.
...
GO
DROP VIEW [dbo].[RQ_STATUT_DC_CAND]
GO
CREATE VIEW [dbo].[RQ_STATUT_DC_CAND]
                    AS
...
GO                    
INSERT [dbo].[__MigrationHistory]([MigrationId], [ContextKey], [ProductVersion], Model)
VALUES (N'202408271230345_ExtractionCAFDESV2', N'GestVAEcls.Migrations.Configuration' , N'6.2.0-61023', 000)
GO
--Application d'une migration explicite : 202410020935283_StatutL1.
DELETE MotifGeneralL1
GO
DELETE MotifGeneralL2
GO
insert into MotifGeneralL1 (Libelle,dateCreation,dateModif,bDeleted) Values ('Vous n avez pas fourni les pièces complémentaires attendues dans les délais impartis',getDate(), getDate(), 0)
GO
insert into MotifGeneralL1 (Libelle,dateCreation,dateModif,bDeleted) Values ('Vous ne justifiez pas des compétences attendues pour valider le Livret 1',getDate(), getDate(), 0)
GO
insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 1  - Participer à l’élaboration de projets stratégiques en lien avec la mise en oeuvre des politiques publiques',getDate(), getDate(), 0)
GO
insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 2 - Définir et piloter le projet d’établissement ou de service',getDate(), getDate(), 0)
GO
insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 3 - Manager et gérer les ressources humaines de l’établissement ou du service',getDate(), getDate(), 0)
GO
insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 4 - Gérer les volets économique, financier et logistique de l’établissement ou du service',getDate(), getDate(), 0)
GO
DROP VIEW [dbo].[L1_BLOC_AVALIDER]
GO
CREATE   VIEW [dbo].[L1_BLOC_AVALIDER]
                    AS
                    SELECT L1.ID AS L1_ID, diplomes.Nom as NOM_DIPLOME,
...
GO
INSERT [dbo].[__MigrationHistory]([MigrationId], [ContextKey], [ProductVersion], Model)
VALUES (N'202410020935283_StatutL1', N'GestVAEcls.Migrations.Configuration', N'6.2.0-61023',000)
