            ...
            Sql(@"CREATE VIEW[dbo].[RQ_L1_DOC]
                    ...
                    SELECT        
                         ...
                         dbo.Candidats.Tel3, dbo.Candidats.bHandicap, 
                            ...
                            dbo.Livret1_NonClos.DateReceptEHESP AS date1ereReceptEHESP, dbo.Livret1_NonClos.EtatLivret, dbo.Juries.DateJury, dbo.Juries.NomJury, dbo.Juries.LieuJury, dbo.Juries.HeureJury, 
                            dbo.Juries.HeureConvoc, dbo.Juries.Decision, dbo.Livret1_NonClos.DateValidite, 
                            ...
                            dbo.Livret1_NonClos.DateEnvoiEHESP, dbo.Livret1_NonClos.DateReceptEHESPComplet,                              dbo.Juries.DateNotificationJury, dbo.Juries.DateNotificationJuryRecours, 
                            ...
                            dbo.Livret1_NonClos.DateDemande1erRetour, dbo.Livret1_NonClos.DateDemande2emeRetour, dbo.Livret1_NonClos.IsConvention, 
...
FROM            dbo.Livret2 INNER JOIN
            ...
            Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION UP]" + "ColEtatcivilDansExtraction " + " end");
        }
