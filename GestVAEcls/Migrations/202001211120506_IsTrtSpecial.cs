namespace GestVAEcls.Migrations
{
    ...
    public partial class IsTrtSpecial : DbMigration
    {
        public override void Up()
        {
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION UP]" + "IsTrtSpecial " + "start");
            AddColumn("dbo.Livret2", "IsTrtSpecial", c => c.Boolean(nullable: false));
...
FROM            dbo.Livret2 INNER JOIN
            ...
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION UP]" + "IsTrtSpecial " + "end");
        }

        public override void Down()
        {
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION DOWN]" + "IsTrtSpecial " + "start");
            DropColumn("dbo.Livret2", "IsTrtSpecial");
...
FROM            dbo.Livret2 INNER JOIN
            ...
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION DOWN]" + "IsTrtSpecial " + "end");
        }
    }
}
