namespace GestVAEcls.Migrations
{
    ...
    public partial class OUINON : DbMigration
    {
        public override void Up()
        {
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION UP]" + "OUINON " + "start");
...
");
        ...
        {
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION DOWN]" + "OUINON " + "start");
...
FROM            dbo.Livret2 INNER JOIN
                         ...
                         dbo.Juries ON dbo.Livret2.ID = dbo.Juries.Livret2_ID
");
            System.Diagnostics.Trace.WriteLine(DateTime.Now.ToLongDateString() + ":[DBMIGRATION DOWN]" + "OUINON " + "end");
        }
    }
}
