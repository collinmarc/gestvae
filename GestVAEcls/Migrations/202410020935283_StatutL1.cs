namespace GestVAEcls.Migrations
{
    ...
    public partial class StatutL1 : DbMigration
    {
        public override void Up()
        {
            Sql(@"DELETE MotifGeneralL1");
            Sql(@"DELETE MotifGeneralL2");
            Sql(@"insert into MotifGeneralL1 (Libelle,dateCreation,dateModif,bDeleted) Values ('Vous n avez pas fourni les pièces complémentaires attendues dans les délais impartis',getDate(), getDate(), 0)");
            Sql(@"insert into MotifGeneralL1 (Libelle,dateCreation,dateModif,bDeleted) Values ('Vous ne justifiez pas des compétences attendues pour valider le Livret 1',getDate(), getDate(), 0)");
            Sql(@"insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 1  - Participer à l’élaboration de projets stratégiques en lien avec la mise en oeuvre des politiques publiques',getDate(), getDate(), 0)");
            Sql(@"insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 2 - Définir et piloter le projet d’établissement ou de service',getDate(), getDate(), 0)");
            Sql(@"insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 3 - Manager et gérer les ressources humaines de l’établissement ou du service',getDate(), getDate(), 0)");
            Sql(@"insert into MotifGeneralL2 (Libelle,dateCreation,dateModif,bDeleted) Values ('Bloc de compétences n° 4 - Gérer les volets économique, financier et logistique de l’établissement ou du service',getDate(), getDate(), 0)");
