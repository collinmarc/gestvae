...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret1 ON dbo.Candidats.ID = dbo.Livret1.oCandidat_ID LEFT OUTER JOIN
...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret1 ON dbo.Candidats.ID = dbo.Livret1.oCandidat_ID
...
FROM            dbo.PieceJointeL1 INNER JOIN
                         dbo.L1_RECUS_INCOMPLETS ON dbo.PieceJointeL1.oLivret_ID = dbo.L1_RECUS_INCOMPLETS.IDLIVRET1
...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret1 ON dbo.Candidats.ID = dbo.Livret1.oCandidat_ID LEFT OUTER JOIN
                         dbo.Recours ON dbo.Livret1.ID = dbo.Recours.oLivret_ID AND dbo.Livret1.ID = dbo.Recours.oLivret_ID LEFT OUTER JOIN
                         dbo.Juries ON dbo.Livret1.ID = dbo.Juries.Livret1_ID
...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret2 ON dbo.Candidats.ID = dbo.Livret2.oCandidat_ID LEFT OUTER JOIN
...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret2 ON dbo.Candidats.ID = dbo.Livret2.oCandidat_ID INNER JOIN
...
FROM            dbo.Candidats INNER JOIN
                         dbo.Livret2 ON dbo.Candidats.ID = dbo.Livret2.oCandidat_ID
...
AS
SELECT        dbo.PieceJointeL2.oLivret_ID, dbo.PieceJointeL2.Categorie, dbo.PieceJointeL2.Libelle
FROM            dbo.L2_RECUS_INCOMPLETS INNER JOIN
                         dbo.PieceJointeL2 ON dbo.L2_RECUS_INCOMPLETS.IDLIVRET2 = dbo.PieceJointeL2.oLivret_ID
